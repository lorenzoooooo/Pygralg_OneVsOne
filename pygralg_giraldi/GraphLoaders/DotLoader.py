...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 14 11:22:54 2019
...
class DotLoader:
    ...
    def load(self, folder):
        ...
        # results = pool.map(self.__Preader, files_path)
        # pool.close()
        # pool.join()
        # return results
        graphPattern = {}
...
#    def __Preader(self,dot):
#        g = convert_node_labels_to_integers(Graph(nx_pydot.read_dot(dot)), 0, 'default', None)
#        """ User Defined Parser"""
#        self.__parseGraph(g)
#        """"""
#        return g
